...
const About = () => {
  return (
    <div className="container mb-5">
      ...
      <p>
        I also enjoy experimenting with various forms of art, including both traditional media (drawing, painting, miniatures, metalsmithing, and more) as well as digital media (Photoshop, Illustrator, video editing, animation, 3D modeling).
      </p>
      <div className="d-flex gap-2">
      ...
      <p>
        Want to learn more about my background and experiences? Email me at <a href="mailto:avarady94@gmail.com">avarady94@gmail.com</a>!
      </p>
    </div>
  );
};
