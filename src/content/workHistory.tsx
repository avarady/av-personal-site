export const workHistory = [
    {
        ...
        listItems: [
            ...
            "Optimized API and database queries, increasing speed and responsiveness by up to 50%.",
    ...
    },
    {
        ...
        description: "Co-founded Team 4th Dimension, a start-up specializing in the development of web and mobile application solutions.",
        listItems: [
